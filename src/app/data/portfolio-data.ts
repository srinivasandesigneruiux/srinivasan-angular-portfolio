...
export const PORTFOLIO_ITEMS: PortfolioItem[] = [
  {
    ...
    thumb: 'assets/images/thumbline/primetrip.png',
    filters: ['mobile'],
  ...
  },
  {
    ...
    thumb: 'assets/images/thumbline/upexcise.png',
    filters: ['html', 'mobile'],
    modalId: 'upexcise',
  },
  {
    ...
    thumb: 'assets/images/thumbline/emp-portal.png',
    filters: ['html'],
  ...
  },
  {
    ...
    thumb: 'assets/images/thumbline/emp-portal-app.png',
    filters: ['mobile'],
  ...
  },
  {
    ...
    thumb: 'assets/images/thumbline/pharma.png',
    filters: [],
  ...
  },
  {
    ...
    thumb: 'assets/images/thumbline/tnpds.png',
    filters: [],
    modalId: 'myModal',
  },
  {
    ...
    thumb: 'assets/images/thumbline/ocx-labs.png',
    filters: ['html'],
    modalId: 'ocx',
  },
  {
    ...
    thumb: 'assets/images/thumbline/coptex.png',
    filters: ['html'],
    modalId: 'coptext',
  },
  {
    ...
    thumb: 'assets/images/thumbline/pms.png',
    filters: ['html'],
    modalId: 'pms',
  },
  {
    ...
    thumb: 'assets/images/thumbline/ocx.png',
    filters: ['mobile'],
  ...
  },
  {
    ...
    thumb: 'assets/images/thumbline/grapic-design.png',
    filters: ['photoshop'],
    modalId: 'gdwork',
  },
  {
    ...
    thumb: 'assets/images/thumbline/uiux.png',
    filters: ['figma'],
    modalId: 'figma',
  },
];
...
export const MODAL_GALLERIES: Record<string, ModalGallery> = {
  ...
  empportalapp: {
    id: 'empportalapp',
    title: 'Employee Portal App',
    images: [P + 'emp-full-screen.jpg'],
  },
  ocx: {
    id: 'ocx',
    title: 'OCX Labs',
    images: [
      P + 'tnpds/OCX-Labs-1.png',
      P + 'tnpds/OCX-Labs-2.png',
    ...
    tabs: [
      ...
      },
      {
        ...
        images: [
          ...
          P + 'coverdesign/030-Cover-Image-for-Project-Dairy-Cover-Design.jpg',
        ],
      },
    ],
  },
  ...
  primetripapp: {
    ...
    images: [
      P + 'mobile-app/primetrip/1.jpg',
      P + 'mobile-app/primetrip/2.jpg',
      P + 'mobile-app/primetrip/3.jpg',
      P + 'mobile-app/primetrip/4.jpg',
      P + 'mobile-app/primetrip/5.jpg',
      P + 'mobile-app/primetrip/6.jpg',
    ],
  },
  pms: {
    id: 'pms',
    ...
    images: [
      P + 'redmine/login-1.png',
      P + 'redmine/dashboard-2.png',
  ...
  oasyspharmaapp: {
    ...
    images: [P + 'oasys-pharma-app/OASYS-Pharma-App-Portfolio-Mockup-White-BG.png'],
  },
  figma: {
    id: 'figma',
    title: 'Figma Works',
